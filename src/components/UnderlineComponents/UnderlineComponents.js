import "./UnderlineComponents.css";
import Highlight from "react-highlight"
import "../../assets/css/stackoverflow-dark.css";

const UnderlineComponents = () => {
    return (
        <>
            <div className="grid-container background-grey">
                <div className="col">
                    ...
                    <Highlight className="html">
                        {'<!-- HTML --> <h2><span className="fancy-underline-blue underline-thin">Thin Fancy underline</span></h2>'}
                    </Highlight>
                    <Highlight className="css">
                        {'/*** CSS ***/ .underline-thin {background-size: 100% 0.2em;} .fancy-underline-blue {background-image: linear-gradient(120deg, rgba(93, 178, 254, 0.4) 0%, rgba(93, 178, 254, 0.4) 100%); background-repeat: no-repeat;background-position: 0 100%; transition: background-size 0.25s ease-in; width: fit-content; } '}
                    </Highlight>
                </div>
                ...
                <div className="col">
                    ...
                    <Highlight className="html">
                        {'<h2><span className="fancy-underline-yellow underline-light">Light Fancy underline</span></h2>'}
                    </Highlight>
                    <Highlight className="css">
                        {'/*** CSS ***/ .underline-light {background-size: 100% 0.3em;} .fancy-underline-yellow {background-image: linear-gradient(120deg, rgba(220, 253, 0, 0.4) 0%, rgba(220, 253, 0, 0.4) 100%); background-repeat: no-repeat; background-position: 0 100%; transition: background-size 0.25s ease-in; width: fit-content; }'}
                    </Highlight>
                </div>
                ...
                <div className="col">
                    <div className="flex-container">
                        <a href="/" className="link link--glitch">Discover</a>
                    </div>
                </div>

                <div className="col">
                    <div className="flex-container">
                        <a href="/" className="link link--carme">
                            <span>Drawned</span>
...
export default UnderlineComponents;